...
The first problem I encountered was when I initially tried to render the markdown. I had an error in my .yml file and it turns out I was using the 'tab' button to write spaces, which isn't allowed in .yml files. The second problem I had was when I tried to embedded my resume in a markdown file. I was trying to embed this file in a R chunk, but this was not neccessary and ran only when I got rid of the R chunk in my markdown file. I intend to use this website in the future to showcase my own research, as well as any other interesting things I learn during future internships or jobs. 

Link to my website's repository: https://github.com/glcoll16/glcoll16.github.io    
