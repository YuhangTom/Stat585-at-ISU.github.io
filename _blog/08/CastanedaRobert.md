...
3. Rename the <LastnameFirstname>`.Rmd` in your repo. Write at least 2-3 sentences describing the problems you encountered while following these instructions, how you solved them, and how you anticipate using this site in the future. 
    ...
    I ran into some problems figuring out how the yml file worked and how to edit that with how I wanted my website to work. This was really just trial and error. I also had issues uploading a pdf file but found the correct answer on stackoverflow. I anticipate potentially using this method of bulding a site to create a personalized page that I can use when applying for jobs.
...
my website: https://github.com/rcast1215/rcast1215.github.io
