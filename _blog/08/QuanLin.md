...
<ul><b> My blog is [https://xiaolinzi1112.github.io](https://xiaolinzi1112.github.io). The biggest problem is that I cannot publish my blog. After checking the rules of `create a new repository`, I realize that I should use the same name as my github name. In the future I need to change my github name to my real name, then I can generate `linquan.github.io`. Also, it's hard for me to add new tab at first. After finding a good template, it's easy for me to edit it. In the future, I will polish this site and add more my research to make it as my homepage.</b></ul> 
