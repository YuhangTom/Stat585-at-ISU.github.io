...
3. Rename the <LastnameFirstname>`.Rmd` in your repo. Write at least 2-3 sentences describing the problems you encountered while following these instructions, how you solved them, and how you anticipate using this site in the future.
    ...
    While making '_site.yml', I encountered a problem regarding 'tab' spaces which later I understood that 'yaml' files don't render tabs. Then I removed     those tab spaces and the problem was solved. I hope to use this site as my personal portfolio website where I would showcase my projects that I have       worked on.
