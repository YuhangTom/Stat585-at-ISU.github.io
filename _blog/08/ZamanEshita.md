...
3. Rename the <LastnameFirstname>`.Rmd` in your repo. Write at least 2-3 sentences describing the problems you encountered while following these instructions, how you solved them, and how you anticipate using this site in the future. 
    I have created my website using simple Rmarkdown websites. To create the basic Rmarkdown website, I did not encounter any error. However, when I tried to add an image to my website, it was not showing up at first. I had to make some changes and update the entry in the CSS file correctly.  I have also added a favicon icon in my website. I got help from the internet to apply that succesfully. My website contains my bio, contact information and description of few projects that I have worked on. I am working on uploading my CV in the website. In future, I want to add more contents about my travelling, reading and movies that I enjoyed watching. I plan to add the link of the website in my email signature.
